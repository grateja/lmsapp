...
class ProductsSeeder(dao: DaoProduct): EntitySeederImpl<EntityProduct>(dao) {
    override fun items(): List<EntityProduct> {
        return listOf(
            EntityProduct("Ariel",15f, 100f, EnumMeasureUnit.SACHET, 1f, EnumProductType.DETERGENT),
            EntityProduct("Downy",15f, 100f, EnumMeasureUnit.SACHET, 1f, EnumProductType.FAB_CON),
            EntityProduct("Hanger",35f, 100f, EnumMeasureUnit.PCS, 1f, EnumProductType.OTHER),
            EntityProduct("Plastic",5f, 100f, EnumMeasureUnit.PCS, 1f, EnumProductType.DETERGENT),
        )
    }
}