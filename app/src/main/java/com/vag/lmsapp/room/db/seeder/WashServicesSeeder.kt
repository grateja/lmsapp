...
class WashServicesSeeder(dao: DaoService): EntitySeederImpl<EntityService>(dao) {
    override fun items(): List<EntityService> {
        return listOf(
            EntityService("Hot Wash", 90f, EntityServiceRef(EnumServiceType.WASH, EnumMachineType.REGULAR_WASHER, EnumWashType.HOT, 47)),
            ...
            EntityService("Hot Wash", 110f, EntityServiceRef(EnumServiceType.WASH, EnumMachineType.TITAN_WASHER, EnumWashType.HOT, 47)),
