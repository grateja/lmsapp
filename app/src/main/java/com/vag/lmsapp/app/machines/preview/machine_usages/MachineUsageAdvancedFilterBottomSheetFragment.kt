...
import com.vag.lmsapp.databinding.FragmentMachineUsageAdvancedFilterBottomSheetBinding
import com.vag.lmsapp.fragments.ModalFragment
import com.vag.lmsapp.util.DataState
import com.vag.lmsapp.util.DateFilter

class MachineUsageAdvancedFilterBottomSheetFragment : ModalFragment<MachineUsageAdvancedFilter>() {
    private val viewModel: MachineUsageAdvancedFilterViewModel by viewModels()
    private lateinit var binding: FragmentMachineUsageAdvancedFilterBottomSheetBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMachineUsageAdvancedFilterBottomSheetBinding.inflate(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.getParcelable<MachineUsageAdvancedFilter>(PAYLOAD).let {
    ...
    companion object {
        fun newInstance(model: MachineUsageAdvancedFilter): MachineUsageAdvancedFilterBottomSheetFragment {
            return MachineUsageAdvancedFilterBottomSheetFragment().apply {
